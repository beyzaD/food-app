...
{
    public static class EvtGridSubscription
    {
            ...
            ILogger log)
        {
            ...
            // Handle an event received from EventGrid. It reads the event from the request payload and send it to the SignalR serverless service using the Azure Function output binding
